...
//                File file = new File(context.getApplicationContext().getFilesDir(), fileName);
                ...
                File file = new File("/data/user/0/com.breezefieldsalesannapurnaswadisht/files", fileName);
                ...
                if(sizeInMb>30){
                        file.delete();
                        file = new File("/data/user/0/com.breezefieldsalesannapurnaswadisht/files", fileName);
                }
